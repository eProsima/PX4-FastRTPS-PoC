...
SensorCombinedPubSubType::SensorCombinedPubSubType() {
	setName("SensorCombined");
	m_typeSize = (uint32_t)SensorCombined::getMaxCdrSerializedSize();
	m_isGetKeyDefined = SensorCombined::isKeyDefined();
	m_keyBuffer = (unsigned char*)malloc(SensorCombined::getKeyMaxCdrSerializedSize()>16 ? SensorCombined::getKeyMaxCdrSerializedSize() : 16);
}
...
bool SensorCombinedPubSubType::serialize(void *data, SerializedPayload_t *payload) {
	SensorCombined *p_type = (SensorCombined*) data;
...
bool SensorCombinedPubSubType::deserialize(SerializedPayload_t* payload, void* data) {
	SensorCombined* p_type = (SensorCombined*) data; 	//Convert DATA to pointer of your type
...
std::function<uint32_t()> SensorCombinedPubSubType::getSerializedSizeProvider(void* data) {
    return [data]() -> uint32_t { return (uint32_t)type::getCdrSerializedSize(*static_cast<SensorCombined*>(data)); };
}

void* SensorCombinedPubSubType::createData() {
	return (void*)new SensorCombined();
}

void SensorCombinedPubSubType::deleteData(void* data) {
	delete((SensorCombined*)data);
}

bool SensorCombinedPubSubType::getKey(void *data, InstanceHandle_t* handle) {
	if(!m_isGetKeyDefined)
		return false;
	SensorCombined* p_type = (SensorCombined*) data;
	eprosima::fastcdr::FastBuffer fastbuffer((char*)m_keyBuffer,SensorCombined::getKeyMaxCdrSerializedSize()); 	// Object that manages the raw buffer.
	eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::BIG_ENDIANNESS); 	// Object that serializes the data.
	p_type->serializeKey(ser);
	if(SensorCombined::getKeyMaxCdrSerializedSize()>16)	{
		m_md5.init();
